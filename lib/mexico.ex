defmodule Mexico do
  ...
  Mr. Garcia is a business owner interested in providing great service
  ...
  Garcia, built a database in elixir that we can use !
  ...
  "Interactive Elixir" and we will be using it to access Mr. Garcia's
  database.

  [This guide](http://elixir-lang.org/getting-started/introduction.html#interactive-mode)
  will help you out.

  [You land and you learn about iex]

  # Interact with the database

  Mr. Garcia wants to know how if the database is
  """
